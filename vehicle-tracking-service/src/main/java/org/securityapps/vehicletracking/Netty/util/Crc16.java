...
public final class Crc16 {
    ...
    // CRC-ITU lookup table (polynomial 0x1021) used by GT06 protocol
    ...
    private Crc16() {} // utility class

    // Computes CRC-ITU (CRC-16) for GT06 frames
    public static int compute(byte[] data) {
        int crc = 0xFFFF; // initial value

        for (byte b : data) {
            crc = ((crc >> 8) ^ TABLE[(crc ^ (b & 0xFF)) & 0xFF]) & 0xFFFF;
        }
